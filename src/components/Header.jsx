        ...
        <div className='w-full bg-white min-h-[10vh] fixed left-0 top-0'>
            <div className="container mx-auto items-center min-h-[10vh] flex justify-between">
                ...
                <div className="links">
                    ...
                    <Link className='mx-2 hover:underline hover:text-black text-gray-500 hover:font-medium' to="/Application">Application</Link>
                ...
                <div className="profile cursor-pointer flex justify-center items-center">
                    ...
                    <h1 className='mx-2 font-medium text-sm '>{UserData?UserData.name:"name"}</h1>
