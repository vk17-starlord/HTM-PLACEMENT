...
function LandingPage() {
  return (
    <div className="flex flex-col justify-between h-screen ">
      <div className="h-20 flex flex-row justify-evenly items-center">
      ...
      <div className="flex flex-col justify-evenly items-center  h-full bg-slate-50">
        ...
        <div className="font-semibold text-xl  ">
          Let's Get beyond the college placement.Let's get beyond the network.
          <p>Let Your Skills and Hardwork pay off here.</p>
        </div>
        <a
          href="/sign-in"
          className="bg-blue-600 px-20 py-2 rounded-lg text-white"
        >
          Get Started
        </a>
