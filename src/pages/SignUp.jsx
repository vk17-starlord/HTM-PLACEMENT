  ...
  return (
    <div className="grid grid-cols-2 items-center h-screen">
      <Formik
        ...
        onSubmit={(values) => {
          axios
            .post("https://htm-project.herokuapp.com/users/add", {
              name: values.name,
              email: values.email,
            ...
            <Form className="flex flex-col justify-center items-start lg:items-center  h-full w-auto mx-6 lg:mr-36">
              ...
              <div className="m-4 w-72 lg:w-96">
                ...
                <Field
                  ...
                  className={
                    errors.name
                      ? ` w-[25rem] lg:w-[30rem]   pl-8 py-2 rounded border-red-400 border-2`
                      : "w-[25rem] lg:w-[30rem]   pl-8 py-2 rounded border-2"
                  }
